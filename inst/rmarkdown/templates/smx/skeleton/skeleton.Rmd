...
# SMB     30    73
# SMH     35    77, 78
# year = 2021 acts as a dummy below, since no 2022 data yet. Are kind of
#  pretending that we are still in the SMH 2021 survey.
#  NOTE: In normal "live operation", year is not filled in the arguement
res <- xe::import_hafvog(id = 35, gid = c(77, 78), year = 2021)
# Here specify whatever cruise(s) you want to include.
#  Make sure that these cruises are in your Hafvog, change accodingly
